...
# select RECM, year 2, cotton>cotton>cotton>cotton sequence
seqmet2 <- seqmet[which(seqmet$Location == "RECM" & seqmet$Yr=="2" & seqmet$SequenceLet=="Ct>Ct>Ct>Ct"),]
...
save(list=ls(), file=paste0(path,"list-recm-year-2-ctctctct.RData"))
